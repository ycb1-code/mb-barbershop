    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none transition"
      ...
      <div className="mt-6 text-center">
        <Link href="/manage" className="text-gray-700 hover:text-gray-600 underline">
